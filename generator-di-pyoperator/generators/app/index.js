...
function _vctl_ls(gen,op_package) {
  ...
  package_path = package_path.replace(/\\/g,'/');
...
function _vctl_read(gen,operator_path) {
  ...
  operator_path = operator_path.replace(/\\/g,'/');
  ...
  */
  ...
  writing() {
    ...
    */
    ...
    let import_mock_api = `# DI-PYOPERATOR GENERATED - DO NOT CHANGE this line and the following 3 lines (Deleted when uploaded.)
